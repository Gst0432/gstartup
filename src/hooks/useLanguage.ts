...
const translations = {
  fr: {
    ...
    // Shops Page
    discoverShops: 'Découvrez nos Boutiques',
    exploreShops: 'Explorez une sélection de boutiques en ligne proposant des produits et services de qualité',
    searchShop: 'Rechercher une boutique...',
    sortBy: 'Trier par',
    nameAZ: 'Nom A-Z',
    bestRated: 'Meilleures notes',
    topSelling: 'Plus vendues',
    newest: 'Plus récentes',
    verified: 'Vérifiées',
    shopsFound: 'boutique trouvée',
    shopsFounds: 'boutiques trouvées',
    page: 'Page',
    of: 'sur',
    noShopsFound: 'Aucune boutique trouvée',
    tryDifferentSearch: 'Essayez de modifier vos critères de recherche',
    noShopsAvailable: 'Il n\'y a pas encore de boutiques disponibles',
  ...
  en: {
    ...
    // Shops Page
    discoverShops: 'Discover our Shops',
    exploreShops: 'Explore a selection of online shops offering quality products and services',
