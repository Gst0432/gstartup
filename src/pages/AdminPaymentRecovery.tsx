      ...
      <div className="space-y-6 p-6">
        ...
        <Alert className="border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            <strong>Page de récupération des paiements :</strong> Utilisez cette interface pour débloquer manuellement les paiements Moneroo qui n'ont pas été confirmés automatiquement.
          </AlertDescription>
        </Alert>
