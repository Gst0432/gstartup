...
DROP TABLE IF EXISTS public.community_leaderboard CASCADE;
...
DROP TABLE IF EXISTS public.ideas_with_details CASCADE;
DROP TABLE IF EXISTS public.affiliates CASCADE;
DROP TABLE IF EXISTS public.community_posts CASCADE;
DROP TABLE IF EXISTS public.documents CASCADE;
DROP TABLE IF EXISTS public.community_posts_with_authors CASCADE;
